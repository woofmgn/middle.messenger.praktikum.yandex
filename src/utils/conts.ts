...
export const contacts = [
  ...
  {
    avatar: emptyContactAvatar,
    message: 'И Human Interface Guidelines и Material Design рекомендуют апваhdfylfasd вапавп',
    name: 'Ирина',
    date: 'Вчера',
  },
  {
...
export const messages = [
  ...
  },
  {
    time: '12:13',
    isOwner: false,
    text: `Сейчас мы все знаем что астронавты летали с моделью 500 EL — и к слову говоря, 
    все тушки этих камер все еще находятся на поверхности Луны, 
    так как астронавты с собой забрали только кассеты с пленкой.`,
  },
  {
